...
if (isset($_REQUEST['delete_id'])) {
    ...
    $select_stmt = $db->prepare('SELECT * FROM orders WHERE Order_ID = :id');
    $select_stmt->bindParam(':id', $id);
    $select_stmt->execute(); 

    
    $delete_stmt = $db->prepare('DELETE FROM orders WHERE Order_ID = :id');
      ...
      <div class="container h-100">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto h-100">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="listOrder.php">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <!-- <td><img src="img/<?php echo $row['image']; ?>" width="100px" height="100px" alt=""></td> -->    
                    <td><?php echo number_format($row["Total_price"],2); ?></td>
                    <td><?php echo $row['Cus_ID']; ?></td>        
                    <td><?php echo $row['food_id']; ?></td> 
                    <td><?php echo $row['Order_date']; ?></td>                                   
                    <td><a href="?delete_id=<?php echo $row['food_id']; ?>" class="btn btn-danger">Clear Order</a></td>                        
                </tr>
            <?php } ?>
        </tbody>
    </table>
