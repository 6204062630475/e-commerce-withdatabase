...
if(!empty($_SESSION['cart']))
{
	...
	{
		$sql = "select * from food where id=$p_id";
		...
		//remove product
		echo "<td width='46' align='center'><a href='cart.php?id=$p_id&act=remove'>ลบ</a></td>";
		echo "</tr>";
	}
	echo "<tr>";
...
?>
<tr>
<td><a href="pizza.php">กลับหน้ารายการสินค้า</a></td>
